...
int main()
{
    ...
    // -------------------------
    Shader shader("csm_shadow_mapping.vs", "csm_shadow_mapping.fs");
    Shader simpleDepthShader("csm_shadow_mapping_depth.vs", "csm_shadow_mapping_depth.fs", "csm_shadow_mapping_depth.gs");
